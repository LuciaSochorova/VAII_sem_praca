...
<form id="recipeForm"  enctype="multipart/form-data" class="my-4 d-flex flex-column align-items-center w-100"
    ...
    <div class="text-center d-flex flex-column align-items-center w-50">
        ...
        <input type="text" id="recipeTitle" name="title" class="form-control" placeholder="Napíš názov receptu"
    ...
    <div class="mb-3 d-flex flex-column align-items-center w-75">
        ...
        <textarea id="recipeDescription" name="description" class="form-control" rows="3" placeholder="Napíš stručný popis receptu"
                  required><?= @$data["recipe"]?->getDescription() ?></textarea>
    </div>

    <div class="mb-3 d-flex flex-column align-items-center w-75">
        <label for="recipeImageInput" class="form-label">Obrázok receptu</label>
    ...
    <div class="row mb-3 gx-2 w-75 align-items-end">
        <div class="col">
            ...
            <input type="number" name="portions" min="1" oninput="validity.valid||(value='');" class="form-control"
        ...
        <div class="col">
            ...
            <input type="number" name="minutes" min="1" oninput="validity.valid||(value='');" class="form-control"
        ...
        <div class="col">
            ...
            <select class="form-control" id="categoryOfFood" name="category">
    ...
    <div class="mb-3 d-flex flex-column align-items-center w-75">
        ...
        <textarea id="recipeNotes" name="notes" class="form-control" rows="2" placeholder="Poznámky ku receptu"><?= @$data["recipe"]?->getNotes() ?></textarea>
    </div>


    <div class="mb-2 d-flex flex-column align-items-center w-50">
        <button type="submit" class="btn btn-success w-100" id=saveRecipe>Uložiť recept</button>
    </div>
