...
import {RecipeDeleteModal} from "./recipeManagment/RecipeDeleteModal.js";
...
if (document.getElementById("recipeAdministrationPage")) {
    document.recipeDeleteModal = new RecipeDeleteModal();
}
